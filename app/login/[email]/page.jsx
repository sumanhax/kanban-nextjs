        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
            <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-lg mx-4">
                ...
                <div className="mt-6 flex justify-end gap-3">
                    ...
                    <button onClick={handleSendEmail} disabled={isSending} className="px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 disabled:bg-blue-300">{isSending ? 'Sending...' : 'Send Email'}</button>
                </div>
            </div>
        </div>
    );
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex justify-between items-center mb-6">
                       ...
                       <div className="flex gap-5">
                        ...
                        <button onClick={() => setIsModalOpen(true)} className="px-4 py-2 bg-indigo-600 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">Send New Email</button>
                       </div>
                        </div>
                                            ...
                                            <tr key={idx} className="hover:bg-blue-50 cursor-pointer transition-all"
                                                ...
                                                <td className="px-4 py-3 text-gray-600">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {thread.length > 1 && (<span className="bg-indigo-600 text-white text-xs font-bold px-2 py-0.5 rounded-full">{thread.length}</span>)}
                                                    </div>

...
export default function EmailIndividual({ onBack, currentUserEmail, otherPartyEmail, initialSubject }) {
    ...
    // This function now fetches ALL emails and filters down to the current conversation
        ...
        <div className="bg-white rounded-xl shadow p-4 sm:p-6">
            ...
            <div className="mt-6 pt-4 border-t">
                ...
                <div className="mt-3 flex justify-end">
                    <button onClick={handleSendReply} className="px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 disabled:bg-blue-300 disabled:cursor-not-allowed transition-colors" disabled={!replyText.trim() || isSending}>
